        ...
        <section id='message' className="py-12 pb-20 px-4 flex justify-center items-center bg-gradient-to-b from-transparent/0 to-black/20">
            <div className="w-full max-w-lg mx-auto text-center fade-up">
                ...
                <p className="text-sm text-gray-300 mb-6">
                    Whether you’re hiring for your company or need help with a project, I’m here to collaborate.
                </p>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    className="my-2 border border-white/15 rounded-lg px-3 py-2.5 bg-black/25 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-[#00ffd9] focus:ring-2 focus:ring-[#00ffd9]/40 transition-all"
                                    required
                                />
                            </div>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <textarea
                                    ...
                                    className="my-2 border border-white/15 rounded-lg px-3 py-2.5 bg-black/25 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-[#00ffd9] focus:ring-2 focus:ring-[#00ffd9]/40 transition-all min-h-[120px] resize-none"
                                    required
                                />
                            </div>
                            ...
                            <button
                                ...
                                className=" my-2 mt-2 inline-flex items-center justify-center w-full rounded-lg bg-gradient-to-r from-[#00ffd9] to-cyan-400 text-black font-semibold text-sm sm:text-base px-4 py-2.5 hover:shadow-[0_0_25px_rgba(0,255,217,0.6)] hover:scale-[1.01] transition-transform duration-200 disabled:opacity-70"
                            >
